...
Настроим EVPN multihoming. В отличие от mclag тут не нужны линки между Leaf (peerlink) и можно подключать агрегирование больше чем к двум лифам (в лабе 2, но выключив все и на 3х линках тестировал, мощности в лабе не хватает). Строим между Leaf3 и Leaf4. Конфиг для Leaf3 приведен ниже. stp root также делаем для Leaf3 и Leaf4 - spanning-tree mst 0 priority 8192
