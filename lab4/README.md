...
Настройка Spine коммутаторов одинакова, меняются только соседи. Т.к. у нас eBGP то route-reflector не нужен. Добавим bfd и аутентификацию bgp. Включаем ECMP, в IGP он по умолчанию, в BGP надо включать руками. Для небольшого уменьшения конфигурации добавим peer group
